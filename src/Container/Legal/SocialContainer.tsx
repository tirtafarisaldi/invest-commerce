...
const SocialContainer = () => {
  ...
  const dataAccordionLegal = [
    {
      title: t('socialScreen.reserved'),
      description: t('socialScreen.reservedText'),
    },
  ];
  ...
  return (
    <Container>
      <Content contentContainerStyle={[]} showsVerticalScrollIndicator={false}>
        <HeaderTitle title={t('legalScreen.socmedGuidelines')} />
        <View
          style={[
