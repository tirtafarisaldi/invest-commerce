...
const CircleContainer = () => {
  ...
  const dataAccordionLegal = [
    {
      title: t('circleScreen.reserved'),
      description: t('circleScreen.reservedText'),
    },
  ];
  ...
  return (
    <Container>
      <Content contentContainerStyle={[]} showsVerticalScrollIndicator={false}>
        <HeaderTitle title={t('legalScreen.circleMembership')} />
        <View
          style={[
